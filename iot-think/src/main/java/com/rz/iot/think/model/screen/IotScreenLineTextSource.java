...
public class IotScreenLineTextSource {
    ...
    public IotScreenLineTextSource() {
    }

    public IotScreenLineTextSource(String html, Double lineHeight, Integer speed, Integer left, Integer top, Integer width, Integer height, Integer playTime, Integer timeSpan, String entryEffectStr, String exitEffectStr, Integer entryEffectTimeSpan, Integer exitEffectTimeSpan, String type) {
        this.html = html;
