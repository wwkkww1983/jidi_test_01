...
public class IotScreenWeatherSource {
    ...
    public IotScreenWeatherSource() {
    }

    public IotScreenWeatherSource(String city, Integer code, String html, Double lineHeight, Integer left, Integer top, Integer width, Integer height, Integer playTime, Integer timeSpan, String entryEffectStr, String exitEffectStr, Integer entryEffectTimeSpan, Integer exitEffectTimeSpan, String type) {
        this.city = city;
        this.code = code;
        this.html = html;
